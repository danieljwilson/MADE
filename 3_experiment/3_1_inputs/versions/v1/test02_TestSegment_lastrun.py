...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'C:\\Users\\labadmin\\Dropbox\\LabSharedFolder\\MADE01\\CODE\\test02_TestSegment.psyexp',
...
trials = data.TrialHandler(nReps=50, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions(u'part1.xlsx'),
