...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/djw/Dropbox/LabSharedFolder/01_MADE/CODE/v3_FractionalWeights/b_Part1_Train_lastrun.py',
...
# Initialize components for Routine "good_face"
good_faceClock = core.Clock()
win_one_face = visual.ImageStim(
    win=win, name='win_one_face',units='pix', 
    image='sin', mask=None,
    ori=0, pos=(0, 0), size=[360,360],
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=0.0)
win_one = visual.TextStim(win=win, name='win_one',
...
# Initialize components for Routine "bad_face"
bad_faceClock = core.Clock()
lose_one_face = visual.ImageStim(
    win=win, name='lose_one_face',units='pix', 
    image='sin', mask=None,
    ori=0, pos=(0, 0), size=[360,360],
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=0.0)
lose_one = visual.TextStim(win=win, name='lose_one',
...
# Initialize components for Routine "morph_face"
morph_faceClock = core.Clock()
...
# Initialize components for Routine "good_house"
good_houseClock = core.Clock()
win_one_house = visual.ImageStim(
    win=win, name='win_one_house',units='pix', 
    image='sin', mask=None,
    ori=0, pos=(0, 0), size=[360,360],
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=0.0)
win_one_2 = visual.TextStim(win=win, name='win_one_2',
    text='If you see this house that means you will win $1.00.',
    font='Helvetica',
    pos=(0, .80), height=0.1, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
    depth=-1.0);
continueKey_2 = visual.TextStim(win=win, name='continueKey_2',
    text='press any key to continue',
    font='Helvetica',
    pos=(0, -0.9), height=0.07, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
...
# Initialize components for Routine "bad_house"
bad_houseClock = core.Clock()
lose_one_house = visual.ImageStim(
    win=win, name='lose_one_house',units='pix', 
    image='sin', mask=None,
    ori=0, pos=(0, 0), size=[360,360],
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=0.0)
lose_one_2 = visual.TextStim(win=win, name='lose_one_2',
    text='If you see this house that means you will lose $1.00.',
    font='Helvetica',
    pos=(0, .80), height=0.1, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
# Initialize components for Routine "morph_house"
morph_houseClock = core.Clock()
...
# ------Prepare to start Routine "good_face"-------
t = 0
good_faceClock.reset()  # clock
frameN = -1
continueRoutine = True
# update component parameters for each repeat
win_one_face.setImage(face_df.exemplar[0])
key_resp_4 = event.BuilderKeyResponse()
# keep track of which components have finished
good_faceComponents = [win_one_face, win_one, key_resp_4, continueKey]
for thisComponent in good_faceComponents:
    if hasattr(thisComponent, 'status'):
        thisComponent.status = NOT_STARTED

# -------Start Routine "good_face"-------
while continueRoutine:
    # get current time
    t = good_faceClock.getTime()
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
    
    # *win_one_face* updates
    if t >= 0.0 and win_one_face.status == NOT_STARTED:
        # keep track of start time/frame for later
        win_one_face.tStart = t
        win_one_face.frameNStart = frameN  # exact frame index
        win_one_face.setAutoDraw(True)
    
    # *win_one* updates
    if t >= 0.0 and win_one.status == NOT_STARTED:
        # keep track of start time/frame for later
        win_one.tStart = t
        win_one.frameNStart = frameN  # exact frame index
        win_one.setAutoDraw(True)
...
# -------Ending Routine "good_face"-------
for thisComponent in good_faceComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
# the Routine "good_face" was not non-slip safe, so reset the non-slip timer
routineTimer.reset()

# ------Prepare to start Routine "bad_face"-------
t = 0
bad_faceClock.reset()  # clock
frameN = -1
continueRoutine = True
# update component parameters for each repeat
lose_one_face.setImage(face_df.exemplar[100])
key_resp_5 = event.BuilderKeyResponse()
# keep track of which components have finished
bad_faceComponents = [lose_one_face, lose_one, key_resp_5, text_5]
for thisComponent in bad_faceComponents:
    if hasattr(thisComponent, 'status'):
        thisComponent.status = NOT_STARTED

# -------Start Routine "bad_face"-------
while continueRoutine:
    # get current time
    t = bad_faceClock.getTime()
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
    
    # *lose_one_face* updates
    if t >= 0.0 and lose_one_face.status == NOT_STARTED:
        # keep track of start time/frame for later
        lose_one_face.tStart = t
        lose_one_face.frameNStart = frameN  # exact frame index
        lose_one_face.setAutoDraw(True)
    
    # *lose_one* updates
    if t >= 0.0 and lose_one.status == NOT_STARTED:
        # keep track of start time/frame for later
        lose_one.tStart = t
        lose_one.frameNStart = frameN  # exact frame index
        lose_one.setAutoDraw(True)
...
# -------Ending Routine "bad_face"-------
for thisComponent in bad_faceComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
# the Routine "bad_face" was not non-slip safe, so reset the non-slip timer
routineTimer.reset()

# ------Prepare to start Routine "morph_face"-------
t = 0
morph_faceClock.reset()  # clock
frameN = -1
continueRoutine = True
# update component parameters for each repeat
man02.setImage(face_df.exemplar[100])
key_resp_7 = event.BuilderKeyResponse()
man01.setImage(face_df.exemplar[0])
man_morph50.setImage(face_df.exemplar[50])
# keep track of which components have finished
morph_faceComponents = [man02, text_6, key_resp_7, text_7, man01, man_morph50, text_8, minus5, zeroDollar]
for thisComponent in morph_faceComponents:
    if hasattr(thisComponent, 'status'):
        thisComponent.status = NOT_STARTED

# -------Start Routine "morph_face"-------
while continueRoutine:
    # get current time
    t = morph_faceClock.getTime()
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
# -------Ending Routine "morph_face"-------
for thisComponent in morph_faceComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
# the Routine "morph_face" was not non-slip safe, so reset the non-slip timer
routineTimer.reset()

# ------Prepare to start Routine "good_house"-------
t = 0
good_houseClock.reset()  # clock
frameN = -1
continueRoutine = True
# update component parameters for each repeat
win_one_house.setImage(house_df.exemplar[0])
key_resp_16 = event.BuilderKeyResponse()
# keep track of which components have finished
good_houseComponents = [win_one_house, win_one_2, key_resp_16, continueKey_2]
for thisComponent in good_houseComponents:
    if hasattr(thisComponent, 'status'):
        thisComponent.status = NOT_STARTED

# -------Start Routine "good_house"-------
while continueRoutine:
    # get current time
    t = good_houseClock.getTime()
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
    
    # *win_one_house* updates
    if t >= 0.0 and win_one_house.status == NOT_STARTED:
        # keep track of start time/frame for later
        win_one_house.tStart = t
        win_one_house.frameNStart = frameN  # exact frame index
        win_one_house.setAutoDraw(True)
    
    # *win_one_2* updates
    if t >= 0.0 and win_one_2.status == NOT_STARTED:
        # keep track of start time/frame for later
        win_one_2.tStart = t
        win_one_2.frameNStart = frameN  # exact frame index
        win_one_2.setAutoDraw(True)
    ...
    # *continueKey_2* updates
    if t >= 0.0 and continueKey_2.status == NOT_STARTED:
        # keep track of start time/frame for later
        continueKey_2.tStart = t
        continueKey_2.frameNStart = frameN  # exact frame index
        continueKey_2.setAutoDraw(True)
...
# -------Ending Routine "good_house"-------
for thisComponent in good_houseComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
# the Routine "good_house" was not non-slip safe, so reset the non-slip timer
routineTimer.reset()

# ------Prepare to start Routine "bad_house"-------
t = 0
bad_houseClock.reset()  # clock
frameN = -1
continueRoutine = True
# update component parameters for each repeat
lose_one_house.setImage(house_df.exemplar[100])
key_resp_17 = event.BuilderKeyResponse()
# keep track of which components have finished
bad_houseComponents = [lose_one_house, lose_one_2, key_resp_17, text_10]
for thisComponent in bad_houseComponents:
    if hasattr(thisComponent, 'status'):
        thisComponent.status = NOT_STARTED

# -------Start Routine "bad_house"-------
while continueRoutine:
    # get current time
    t = bad_houseClock.getTime()
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
    
    # *lose_one_house* updates
    if t >= 0.0 and lose_one_house.status == NOT_STARTED:
        # keep track of start time/frame for later
        lose_one_house.tStart = t
        lose_one_house.frameNStart = frameN  # exact frame index
        lose_one_house.setAutoDraw(True)
    
    # *lose_one_2* updates
    if t >= 0.0 and lose_one_2.status == NOT_STARTED:
        # keep track of start time/frame for later
        lose_one_2.tStart = t
        lose_one_2.frameNStart = frameN  # exact frame index
        lose_one_2.setAutoDraw(True)
...
# -------Ending Routine "bad_house"-------
for thisComponent in bad_houseComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
# the Routine "bad_house" was not non-slip safe, so reset the non-slip timer
routineTimer.reset()

# ------Prepare to start Routine "morph_house"-------
t = 0
morph_houseClock.reset()  # clock
frameN = -1
continueRoutine = True
# update component parameters for each repeat
House01.setImage(house_df.exemplar[100])
key_resp_11 = event.BuilderKeyResponse()
man01_2.setImage(house_df.exemplar[0])
man_morph50_2.setImage(house_df.exemplar[50])
# keep track of which components have finished
morph_houseComponents = [House01, text_9, key_resp_11, continue9, man01_2, man_morph50_2, text_11, minus5_2, zeroDollar_2]
for thisComponent in morph_houseComponents:
    if hasattr(thisComponent, 'status'):
        thisComponent.status = NOT_STARTED

# -------Start Routine "morph_house"-------
while continueRoutine:
    # get current time
    t = morph_houseClock.getTime()
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
# -------Ending Routine "morph_house"-------
for thisComponent in morph_houseComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
# the Routine "morph_house" was not non-slip safe, so reset the non-slip timer
routineTimer.reset()
...
# set up handler to look after randomisation of conditions etc
test_faceValue = data.TrialHandler(nReps=10, method='random', 
    extraInfo=expInfo, originPath=-1,
...
if thisTest_faceValue != None:
    for paramName in thisTest_faceValue:
        exec('{} = thisTest_faceValue[paramName]'.format(paramName))
...
for thisTest_faceValue in test_faceValue:
    ...
    # if they have not passed in five trials then kick them out...
    if roundNumber == 6:
        test_faceValue.finished=1
        nRepsCorrect = 0
...
# completed 10 repeats of 'test_faceValue'
