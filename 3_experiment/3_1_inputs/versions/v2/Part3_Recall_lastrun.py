...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/djw/Dropbox/PHD/CENDRI/Project/Code/LabSharedFolder/MADE01/CODE/v3_FractionalWeights/Part3_Recall.psyexp',
...
Fifty_estimates = visual.TextStim(win=win, name='Fifty_estimates',
    text=u'You will now be randomly shown a series of 50 faces and houses.\n\nPlease fill in your best estimate of the exact value of each.',
    font=u'Arial',
