...
expName = 'Weights_Test'  # from the Builder filename that created this script
expInfo = {'version': 'v3', 'participant': ''}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/djw/Dropbox/LabSharedFolder/01_MADE/CODE/v3_FractionalWeights/a_Part2_Test.py',
