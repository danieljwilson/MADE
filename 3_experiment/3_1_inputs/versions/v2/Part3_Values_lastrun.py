...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/djw/Dropbox/PHD/CENDRI/Project/Code/LabSharedFolder/MADE01/CODE/v3_FractionalWeights/Part3_Values.psyexp',
...
import glob
face_list = sorted(glob.glob('/Users/djw/Dropbox/PHD/CENDRI/Project/Code/LabSharedFolder/MADE01/CODE/v3_FractionalWeights/images/morphs/face/*.jpg'))
house_list = sorted(glob.glob('/Users/djw/Dropbox/PHD/CENDRI/Project/Code/LabSharedFolder/MADE01/CODE/v3_FractionalWeights/images/morphs/house/*.jpg'))
...
update_image = face_df.exemplar[test_x]
update_value = face_df.value[test_x]
...
for thisTrial_3 in trials_3:
    ...
    continueRoutine = True
    # update component parameters for each repeat
    image_3.setImage(update_image)
    key_resp_16 = event.BuilderKeyResponse()
    update_image = face_df.exemplar[test_x]
    update_value = face_df.value[test_x]
    text_10.setText(update_value)
    # keep track of which components have finished
    testComponents = [image_3, text_3, key_resp_16, continueKey_2, text_10]
...
continueRoutine = True
# update component parameters for each repeat
image.setImage(face_df.exemplar[100])
...
continueRoutine = True
# update component parameters for each repeat
image_2.setImage(face_df.exemplar[0])
