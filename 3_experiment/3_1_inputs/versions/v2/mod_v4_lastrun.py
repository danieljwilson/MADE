...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/djw/Dropbox/PHD/CENDRI/Project/Code/LabSharedFolder/MADE01/CODE/v3_FractionalWeights/mod_v4.psyexp',
...
instructions_2 = visual.TextStim(win=win, name='instructions_2',
    text=u'You will need to consider the SUM of the two values in order to decide whether you ACCEPT or REJECT the combination.\n\nIn this case the combined value of the two images is: $0.50 - $0.26 = $0.24.',
    font=u'Helvetica',
...
compValues = visual.TextStim(win=win, name='compValues',
    text=u'Because of the MULTIPLIERS it would make sense to REJECT this combination as the SUMMED VALUE ($0.50 - $0.26 * 3) is -$0.28.',
    font=u'Helvetica',
    pos=(0, -.7), height=0.07, wrapWidth=None, ori=0, 
    color=u'white', colorSpace='rgb', opacity=1,
    depth=-6.0);
...
earnings__3 = visual.TextStim(win=win, name='earnings__3',
    ...
    color='white', colorSpace='rgb', opacity=1,
    depth=-4.0);
learning_earnings1 = visual.TextStim(win=win, name='learning_earnings1',
    text='default text',
    font='Arial',
...
for thisTrial_block in trial_blocks:
    ...
    for thisTrial_2 in trials_2:
        ...
        if counter>=100 and loop_num == 3: # change to 100
            counter = 0
            trials_2.finished=1
...
earnings__3.setText(('$%0.2f' %(earnings + learning_earnings)))
learning_earnings1.setText("Learning Earnings: ${0}".format(learning_earnings))
test_earnings.setText("Test Earnings: ${0}".format(earnings))
# keep track of which components have finished
FinalScoreComponents = [numberEntry_5, FinalEarnings, square_entry_5, earnings__3, learning_earnings1, test_earnings, total_earnings, continue4]
...
while continueRoutine:
    ...
    # *learning_earnings1* updates
    if t >= 0.5 and learning_earnings1.status == NOT_STARTED:
        # keep track of start time/frame for later
        learning_earnings1.tStart = t
        learning_earnings1.frameNStart = frameN  # exact frame index
        learning_earnings1.setAutoDraw(True)
