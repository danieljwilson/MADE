...
v3.2.0: 	accuracy incentive
			.1-10 multipliers
			choose among all 4 weight/value options
        ...
        for trial in trial_count[block]:
            ...
            while this_trial!= 'over':
                keystroke = event.getKeys(
                    keyList=['4', '5','left', 'right', 'up', 'down'])
                ...
                while not response[key._4] and not response[key._5] and not response[key.UP] and not response[key.DOWN]:
