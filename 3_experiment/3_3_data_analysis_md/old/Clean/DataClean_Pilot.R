...
#------------------------#
setwd("~//Dropbox/PHD/CENDRI/Project/Code/LabSharedFolder/DJW_PilotData/20170130/data/Trials")

# CLEAN ENVIRONMENT: removes all variables but NOT functions
...
total_M_v1$finalEarnings = total_M_v1$earnings[total_M_v1$subject * 300]
...
# SAVE AS CSV
write.csv(total_NM_v1, file = "~/Dropbox/PROGRAMMING/*NEURO/2017_MADE/Analysis/Data/NS_NM_Pilot.csv") #Write to Analysis Folder
write.csv(total_M_v1, file = "~/Dropbox/PROGRAMMING/*NEURO/2017_MADE/Analysis/Data/NS_M_Pilot.csv") 
