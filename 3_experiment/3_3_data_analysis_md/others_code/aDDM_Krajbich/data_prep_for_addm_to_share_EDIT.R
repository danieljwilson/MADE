...
save(data_mat,file="~/Dropbox/PROGRAMMING/*NEURO/aDDM_Krajbich/S_M_data_prepped.RData")
save(data_mat,file="~/Dropbox/PROGRAMMING/*NEURO/2017_MADE/Analysis/Data/S_M_data_prepped.RData")
