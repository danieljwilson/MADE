...
%% =========== COLLECT SUBJECTIVE RATINGS OF ALL FOODS =============%
...
%% ============== ASSESS HUNGER LEVELS ==============%
[HungerLevel,HungerLevelRT] = showInstruction(39,PTBParams, 'RequiredKeys',PTBParams.numKeys(1:9));
HungerTime = datestr(now);
logData(datafile,2,HungerLevel,HungerLevelRT,HungerTime);

%% ==============   GET SECOND ROUND OF ATTRIBUTE RATINGS ================%
% runHTRatingChoiceFoods(PTBParams)
