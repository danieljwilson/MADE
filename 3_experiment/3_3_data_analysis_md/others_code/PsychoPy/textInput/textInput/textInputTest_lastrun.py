...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/danieljwilson/Dropbox/PHD/CENDRI/Project/Code/PsychoPy/textInput/textInput/textInputTest.psyexp',
...
text = visual.TextStim(win=win, name='text',
    text='This example shows how to enter text strings in PsychoPy Builder\n\npress SPACE to continue.\n',
    font='Arial',
    pos=[0, 0], height=0.075, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1,
    depth=-1.0);
text_4 = visual.TextStim(win=win, name='text_4',
    text='Author: John Allen - University of Kent, UK',
    font='Arial',
    pos=[0.3, -0.7], height=0.05, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1,
    depth=-3.0);
...
trialComponents = [ISI, text, key_resp_2, text_4]
...
for thisTrial in trials:
    ...
    # keep track of which components have finished
    gatherTextComponents = [text_3, key_resp_3]
