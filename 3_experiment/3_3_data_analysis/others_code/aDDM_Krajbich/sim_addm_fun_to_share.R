...
#nsim is number of simulations, d is drift parameter, sigma is within trial variability in drift, 
#theta is attention parameter, ndt is non-decision time in ms, dsigma is across trial variability in drift. 
