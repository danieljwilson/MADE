...
expName = u'v01'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/danieljwilson/Dropbox/PHD/CENDRI/Project/Code/V01/v01.psyexp',
...
trials = data.TrialHandler(nReps=5, method='random', 
    ...
    trialList=data.importConditions(u'stroop.xlsx'),
