...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/djw/Dropbox/PHD/CENDRI/Project/Code/Test01/test01.psyexp',
...
instructions = visual.TextStim(win=win, name='instructions',
    text='Please let the RA or experimenter know that you have completed Part 1 and are ready to proceed to Part 2.',
    font='Helvetica',
...
instructions_4 = visual.TextStim(win=win, name='instructions_4',
    text=u'Please let the RA or experimenter know that you have completed Part 1 and are ready to proceed to Part 2.',
    font=u'Helvetica',
    pos=(0, -.2), height=0.08, wrapWidth=None, ori=0, 
    color=u'white', colorSpace='rgb', opacity=1,
    depth=0.0);
continue9_5 = visual.TextStim(win=win, name='continue9_5',
    text='press any key to continue',
    font='Helvetica',
    pos=(0, -0.9), height=0.07, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1,
...
# update component parameters for each repeat
# keep track of which components have finished
Part1CompleteComponents = [instructions_4, continue9_5, Part2_2]
...
while continueRoutine:
    ...
    # *continue9_5* updates
    if t >= 0.5 and continue9_5.status == NOT_STARTED:
        # keep track of start time/frame for later
        continue9_5.tStart = t
        continue9_5.frameNStart = frameN  # exact frame index
        continue9_5.setAutoDraw(True)
